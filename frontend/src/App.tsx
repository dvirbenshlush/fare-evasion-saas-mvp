...
import { BusState, KPI, WsMessage, LatLng } from './types'

const WS_URL  = 'ws://localhost:8080'

const DEFAULT_KPI: KPI = {
  totalBuses: 0, alertBuses: 0,
  totalPassengers: 0, totalEvaders: 0, evasionRate: 0,
}
...
export default function App() {
  ...
  useEffect(() => {
    ...
    const connect = () => {
      ...
      ws.onopen  = () => { setConnected(true); backoffRef.current = 500 }
      ws.onclose = () => {
        setConnected(false)
        if (!destroyed) {
